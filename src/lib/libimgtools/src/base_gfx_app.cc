 ...
 ******************************************************************************/
BaseGfxApp::BaseGfxApp(int width, int height)
 ...
 * Member Functions
 ******************************************************************************/
void BaseGfxApp::Init(int argc, char* argv[], int x, int y, unsigned glut_flags,
                      bool create_glui_win, int glui_win_x, int glui_win_y) {
  ...
  if (create_glui_win) {
    glui_ = GLUI_Master.create_glui("Controls", 0, glui_win_x, glui_win_y);
...
void BaseGfxApp::RunMainLoop(void) { glutMainLoop(); }
...
void BaseGfxApp::Reshape(int width, int height) {
  ...
  if (s_current_app_->width() != width || s_current_app_->height() != height) {
...
void BaseGfxApp::DrawPixels(int start_x, int start_y, int width, int height,
...
void BaseGfxApp::s_draw(void) { s_current_app_->RenderOneFrame(); }
...
void BaseGfxApp::InitGraphics(void) {
