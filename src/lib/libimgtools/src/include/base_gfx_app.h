...
class BaseGfxApp {
 public:
  BaseGfxApp(int width, int height);
   ...
   * super class version.
   */
  virtual void Init(int argc, char* argv[], int x, int y, unsigned glut_flags,
   ...
   */
  void DrawPixels(int start_x, int start_y, int width, int height,
